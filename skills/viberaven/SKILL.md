---
name: viberaven
description: Use VibeRaven when an AI-built app or agent needs release drift, version context, architecture context, provider context, or a clear answer to what changed before editing, shipping, deploying, or debugging production-only behavior.
---
